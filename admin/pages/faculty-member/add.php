    ...
    if(isset($_POST['submit']))
    {
        ...
        elseif (mysqli_num_rows(mysqli_query($conn, "select * from members where email='$email'"))) {
            ...
            if ($_FILES["avatar"]["name"]) {
                ...
                $avatar = "uploads/members/faculty/"  . ($_FILES["avatar"]["name"]);
                if (move_uploaded_file($_FILES["avatar"]["tmp_name"], $avatar)) {
                    // Save data to database
                    $sql = mysqli_query($conn, "INSERT INTO members (avatar, name, email, phone, designation, address, short_details,  details, type) VALUES ('$avatar', '$name', '$email', '$phone','$designation', '$address', '$short_details', '$details', 'faculty')");
                    if($sql)
                    {
            ...
            {
                $sql1 = mysqli_query($conn, "INSERT INTO members (name, email, phone, designation, address, short_details,  details, type) VALUES ('$name', '$email', '$phone','$designation', '$address', '$short_details', '$details', 'faculty')");
                if($sql1)
                {
                    $_SESSION['success'] = 'Data Inserted Successfully';
                }
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Faculty Member</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                <li class="breadcrumb-item "><a href="index.php">Home</a></li>
                <li class="breadcrumb-item active"><a href="index.php?page=faculty-member-list"
                        class="text-danger">Faculty Member</a>
                </li>
            </ol>
