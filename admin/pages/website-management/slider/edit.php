...
<?php
       ...
       extract($_POST);
        ...
        if ($heading_one == '') {
            ...
            if ($_FILES["image"]["name"]) {
                $old_image = mysqli_query($conn, "SELECT image FROM photo_sliders WHERE id='".$_GET['id'] ."'");
                if ($old_image) {
                ...
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $image)) {
                    ...
                    $sql = mysqli_query($conn, "UPDATE photo_sliders SET image='$image', heading_one='$heading_one', small_text='$small_text', btn_title='$btn_title', btn_link='$btn_link' WHERE id='".$_GET['id'] ."'");
                    if($sql)
                    {
            ...
            {
                $sql1 = mysqli_query($conn, "UPDATE photo_sliders SET heading_one='$heading_one', small_text='$small_text', btn_title='$btn_title', btn_link='$btn_link' WHERE id='".$_GET['id'] ."'");
                if($sql1)
                {
                    $_SESSION['success'] = 'Data Update Successfully';
                }
    ...
    $result = mysqli_query($conn, 'SELECT * FROM photo_sliders WHERE id="' . $_GET['id'] . '"');
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="m-b-0 text-white"><b>Update Slider</b></h3>
            </div>
            <div class="card-body">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="heading_one" class="form-control"
                                            id="validationCustomUsername" value="<?= $row['heading_one'] ?>"
                                            placeholder="Heading..">
                                    </div>
                                </div>
                                <div class="col-md-12 mt-4">
                                    <div class="input-group">
                                        ...
                                        <textarea rows="1" name="small_text" class="form-control"
                                            ...
                                            placeholder="text here..."><?= $row['small_text'] ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mt-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="btn_title" value="<?= $row['btn_title'] ?>"
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="btn_link" class="form-control"
                                            id="validationCustomUsername" value="<?= $row['btn_link'] ?>"
