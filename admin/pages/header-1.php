        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <!-- <img src="../../public/all/admin/assets/images/logo-icon.png" alt="homepage" class="dark-logo" /> -->
                    <!-- Light Logo icon -->
                    <!-- <img src="../../public/all/admin/assets/images/logo-light-icon.png" alt="homepage"
                        class="light-logo" /> -->
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                                ...
                                <div class="message-center">
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img
                                                src="../../public/all/admin/assets/images/users/1.jpg" alt="user"
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img
                                                src="../../public/all/admin/assets/images/users/2.jpg" alt="user"
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img
                                                src="../../public/all/admin/assets/images/users/3.jpg" alt="user"
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img
                                                src="../../public/all/admin/assets/images/users/4.jpg" alt="user"
                                                class="img-circle"> <span
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="container"> <img class="d-block img-fluid"
                                                    src="../../public/all/admin/assets/images/big/img1.jpg"
                                                    alt="First slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                    src="../../public/all/admin/assets/images/big/img2.jpg"
                                                    alt="Second slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                    src="../../public/all/admin/assets/images/big/img3.jpg"
                                                    alt="Third slide"></div>
                                        </div>
                                    </div>
