    ...
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                ...
                <li class="breadcrumb-item active">Alumni Member</li>
            </ol>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <a href="index.php?page=add-alumni-member"
                    class="btn waves-effect waves-light btn-outline-light float-end">Add
                    New Member</a>

                <h3 class="m-b-0 text-white"><b>Alumni Member</b></h3>
            ...
            <div class="card-body">
                <div class="table-responsive m-t-40">
                    <table id="myTable" class="table table-striped border">
                        ...
                        $q = mysqli_query($conn,  "SELECT * FROM members where type='alumni' ");
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a class="m-0 <?= $row['status' ] == 0 ? 'text-warning': 'text-success'; ?>"
                                        href="index.php?page=alumni-member-list&status_id=<?= $row['id']; ?>">
                                        <i style="font-size:20px"
                                            class="mdi mdi-numeric-<?= $row['status' ] == 0 ? '0-box' : '1-box'; ?>"
                                            style=""></i>
                                    </a>
                                    <a class="" href="index.php?page=edit-alumni-member&id=<?= $row['id'] ?>"
                                        title="Edit"><i class="mdi mdi-lead-pencil text-info"
                                            style="font-size:20px"></i>
                                    </a>
                                    <a class="" href="index.php?page=alumni-member-list&delete_id=<?= $row['id'] ?>"
