        ...
        elseif (mysqli_num_rows(mysqli_query($conn, "select * from members where email='$email'"))) {
            ...
            if ($_FILES["avatar"]["name"]) {
                ...
                if (move_uploaded_file($_FILES["avatar"]["tmp_name"], $avatar)) {
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO members (avatar, name, email, phone, designation, address, semester_no, registration_id, short_details,  details, type) VALUES ('$avatar', '$name', '$email', '$phone','$designation', '$address', '$semester_no', '$registration_id', '$short_details', '$details', 'executive')");
                    if($sql)
                    {
            ...
            {
                $sql1 = mysqli_query($conn, "INSERT INTO members (name, email, phone, designation, address, semester_no, registration_id, short_details,  details, type) VALUES ('$name', '$email', '$phone','$designation', '$address', '$semester_no', '$registration_id', '$short_details', '$details', 'executive')");
                if($sql1)
                {
                    $_SESSION['success'] = 'Data Inserted Successfully';
                }
