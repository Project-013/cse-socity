...
if (isset($_POST['name'])) {
    ...
    $last_blood_donate = mysqli_real_escape_string($conn, $_POST['last_blood_donate']);
    $address = mysqli_real_escape_string($conn, $_POST['address']);
    $skills = mysqli_real_escape_string($conn, $_POST['skills']);
    $interests = mysqli_real_escape_string($conn, $_POST['interests']);

    $sql = "UPDATE `user` SET `name` = '$name', `mobile` = '$mobile', `birthday` = '$birthday',`last_blood_donate`='$last_blood_donate',`address`='$address', `skills`='$skills',`interests`='$interests'  WHERE `UserID` =$UserID";
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active p-3" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control _form_data" id="skills" name="skills" placeholder=" " rows="2"><?php echo $row["skills"] ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="interests">Interests</label>
                                            <textarea class="form-control _form_data" id="interests" name="interests" placeholder=" " rows="2"><?php echo $row["interests"] ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="tab-pane p-3 fade" id="account" role="tabpanel" aria-labelledby="account-tab">
                                    ...
                                    <a href="_delete.php" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete your account?')">Delete Account</a>
